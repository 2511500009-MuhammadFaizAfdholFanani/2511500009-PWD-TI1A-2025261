...
if (!$cmid) {
    ...
    redirect_ke('read_biodataMhs.php');
}

# Ambil data lama dari database
$stmt = mysqli_prepare($conn, "SELECT * FROM tbl_biodata_mahasiswa WHERE cmid = ? LIMIT 1");
if (!$stmt) {
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="read_biodataMhs.php">Data Mahasiswa</a></li>
    ...
    <main>
        <section id="biodata" style="max-width: 800px; margin: 20px auto;">
            ...
            <form action="update_biodataMhs.php" method="POST">
                ...
                <a href="read_biodataMhs.php" style="background-color: #b4b4b4; color: #272727; 
