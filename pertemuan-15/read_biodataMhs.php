...
$sql = "SELECT * FROM tbl_biodata_mahasiswa ORDER BY cmid DESC";
                ...
                <tbody>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($q)): ?>
                        <tr>
                            <td><?= $i++; ?></td>
                            <td class="aksi-btn">
                                <a href="edit_biodataMhs.php?cmid=<?= (int)$row['cmid']; ?>" class="btn-edit">Edit</a>
                                <a href="delate_biodataMhs.php?cmid=<?= (int)$row['cmid']; ?>" 
                                   class="btn-hapus" 
